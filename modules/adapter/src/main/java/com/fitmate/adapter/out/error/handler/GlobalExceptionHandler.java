package com.fitmate.adapter.out.error.handler;

import com.fitmate.adapter.out.error.response.ErrorResponse;
import com.fitmate.domain.error.exceptions.*;
import com.fitmate.domain.error.results.*;
