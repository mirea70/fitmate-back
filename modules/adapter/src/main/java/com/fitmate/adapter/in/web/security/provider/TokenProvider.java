package com.fitmate.adapter.in.web.security.provider;
...
import com.fitmate.adapter.out.persistence.redis.token.RefreshToken;
...
//                .withExpiresAt(new Date(System.currentTimeMillis() + (2 * 1000 )))
    ...
    public Authentication getAuthentication(String token) {
        ...
        if(email != null) {
            AccountJpaEntity accountEntity = accountRepository.getByEmail(email);
