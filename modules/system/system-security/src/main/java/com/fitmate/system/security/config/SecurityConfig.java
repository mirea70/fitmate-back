...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                ...
                .antMatchers("/account/api/join").permitAll()
                .antMatchers("/mate/api/check").permitAll()
                .antMatchers("/chat/api/check").permitAll()
                .antMatchers("/chat/stomp/**").authenticated()
                .antMatchers("/chat/sub/**").authenticated()
                .antMatchers("/chat/pub/**").authenticated()
